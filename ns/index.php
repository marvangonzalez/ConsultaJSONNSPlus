...
$course_fullname = isset($_POST['course_fullname']) ? $_POST['course_fullname'] : 'Nombre del curso no disponible';
?>
...
<head>
    ...
    <script type="text/javascript">
        var nsParams = {
            ...
            courseName: <?php echo json_encode($course_fullname); ?>,
            userId: "1111",
            userEmail: "alumno@mail.com",
            userRole: "student",
            fullname: "Fullname",
            isExam: 0,
            examStartDate: "2024-05-26T00:00:00.000Z", 
            examEndDate: "2024-05-27T00:00:00.000Z",
            documentName: ""
        };
    </script>
</head>
